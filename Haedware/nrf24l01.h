...
//NRF2401片选信号
#define 		CE_L      GPIO_ResetBits(GPIOB, GPIO_Pin_0)
#define 		CE_H      GPIO_SetBits(GPIOB, GPIO_Pin_0)
 
//SPI时钟
#define 		SCK_L	GPIO_ResetBits(GPIOA , GPIO_Pin_4)
#define 		SCK_H	GPIO_SetBits(GPIOA , GPIO_Pin_4)
 
//SPI输入
#define 		READ_MISO	GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_5)
 
//SPI片选信号	
#define 		CSN_L     GPIO_ResetBits(GPIOA, GPIO_Pin_7)
#define 		CSN_H     GPIO_SetBits(GPIOA, GPIO_Pin_7)
...
//IRQ中断脚
#define 		IRQ_L     	GPIO_ResetBits(GPIOA,GPIO_Pin_12) 
#define 		IRQ_H     	GPIO_SetBits(GPIOA,GPIO_Pin_12)
