...
#define LCD_PORT1 GPIOB

#define LCD_PIN_CS GPIO_Pin_8
#define LCD_PIN_RES GPIO_Pin_12
#define LCD_PIN_A0 GPIO_Pin_14
#define LCD_PIN_SDA GPIO_Pin_15
#define LCD_PIN_SCL GPIO_Pin_13
#define LCD_PIN_BLK GPIO_Pin_11


#define SET_LCD_CS 	GPIO_SetBits(LCD_PORT, LCD_PIN_CS)
#define SET_LCD_RES GPIO_SetBits(LCD_PORT1, LCD_PIN_RES)
#define SET_LCD_A0 	GPIO_SetBits(LCD_PORT1, LCD_PIN_A0)
#define SET_LCD_SDA GPIO_SetBits(LCD_PORT1, LCD_PIN_SDA)
#define SET_LCD_SCL GPIO_SetBits(LCD_PORT1, LCD_PIN_SCL)

#define	CLR_LCD_CS  GPIO_ResetBits(LCD_PORT, LCD_PIN_CS)
#define	CLR_LCD_RES GPIO_ResetBits(LCD_PORT1, LCD_PIN_RES)
#define	CLR_LCD_A0  GPIO_ResetBits(LCD_PORT1, LCD_PIN_A0)
#define	CLR_LCD_SDA GPIO_ResetBits(LCD_PORT1, LCD_PIN_SDA)
#define	CLR_LCD_SCL GPIO_ResetBits(LCD_PORT1, LCD_PIN_SCL)
